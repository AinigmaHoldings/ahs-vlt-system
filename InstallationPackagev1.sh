...
##########################################
nano /home/ahsvlt/vlt/cloudflaredserver.sh
##########################################

#!/bin/bash
cloudflared tunnel run vlt-lab-1
...
###########################################
sudo nano /etc/systemd/system/cloudflaredserverssh.service
############################################
[Unit]
Description=test service
After=graphical.target
...
EnvironmentFile=/home/ahsvlt/environment
Restart=always
ExecStart=/bin/sh /home/ahsvlt/vlt/cloudflaredserver.sh
[Install]
WantedBy=default.target
##################################################
